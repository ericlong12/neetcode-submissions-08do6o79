class Solution:
    ...
    # we read that integer until we reach our delimiter "#"
        ...
        # orginal idea was to use a for loop 

        while leftPointer < len(s): # this is to stop when we finish the whole word
            index = leftPointer # this was just to start us off 
            while s[index] != "#": # this was to stop when we reach the delimitor 
